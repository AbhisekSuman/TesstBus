...
import com.example.tesstbus.databinding.ActivityBus1MapBinding;
...
import java.util.List;
 ...
 public class Bus1Map extends FragmentActivity implements OnMapReadyCallback, LocationListener {

    private GoogleMap mMap;
    private ActivityBus1MapBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBus1MapBinding.inflate(getLayoutInflater());
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    try {
                        ...
                        Toast.makeText(Bus1Map.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
         ...
         if (manager != null) {
                        ...
                        ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_BACKGROUND_LOCATION) == PackageManager.PERMISSION_GRANTED)
             {
                 if (manager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                     ...
                     manager.requestLocationUpdates(LocationManager.FUSED_PROVIDER, MIN_TIME, MIN_DISTANCE, this);
                 }
                 else {
